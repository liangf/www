...
f.Writeline ("orderid" & Tab & "orderdate" & Tab & "orderdetailid" & Tab & "productcode" & Tab & "productname")
For Each PrNode In ProductNode
	f.Writeline (Field(PrNode, "orderid") & Tab & Field(PrNode, "orderdate") & Tab & Field(PrNode, "orderdetailid") & Tab & Field(PrNode, "productcode") & Tab & Field(PrNode, "productname") )
Next

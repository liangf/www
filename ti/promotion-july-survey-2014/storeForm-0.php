...
//echo $_GET["ufirstname"];
	...
	echo $_GET["ufirstname"] . "<br>";
	echo $_GET["ulastname"] . "<br>";
	echo $_GET["uaddress"] . "<br>";
	echo $_GET["ucity"] . "<br>";
	echo $_GET["uzip"] . "<br>";
	echo $_GET["ustate"] . "<br>";
	echo $_GET["uemail"] . "<br>";
...
if( $_GET["uemail"] ) {
	...
	//echo $user_eggID;
	$sql = "INSERT INTO july_survey (ID, Q1, Product, Q2, Q3, Q4, Q5, FirstName, LastName, Email, Street, City, State, Zipcode, FormID) 
			VALUES(0, '$q1', '$product', '$q2', '$q3', '$q4', '$q5', '$firstname', '$lastname', '$email', '$address', '$city', '$state', '$zip', $formID)";
	echo $sql;
	mysql_query($sql);		

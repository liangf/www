...
var country = document.getElementById('ti_sur_country').value
...
if (jQuery.browser.msie && window.XDomainRequest) {
            ...
            xdr.onload = function() {
                ...
                dom.async = false;
				document.getElementById('ti_sur_alert').innerHTML = "You have successfully submitted the survey.";
				...
				document.getElementById('ti_sur_country').value = "";

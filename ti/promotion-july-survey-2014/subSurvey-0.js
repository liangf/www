...
if (product_code_radio != null) {
	if (q1=="") {
		//document.getElementsByClassName("ti_sur_alert")[0].innerHTML = "Please answer question 1.";
		document.getElementById('ti_sur_alert0').innerHTML = "Please answer question 1."
		return false;
	} else document.getElementById('ti_sur_alert0').innerHTML = "";
	if (q2==""||q2=="Printer Model") {
		document.getElementById('ti_sur_alert0').innerHTML = "Please answer question 2.";
		return false;
	} else document.getElementById('ti_sur_alert0').innerHTML = "";
	if (q3==""||q3=="MM/DD/YYYY") {
		document.getElementById('ti_sur_alert0').innerHTML = "Please answer question 3.";
		return false;
	} else document.getElementById('ti_sur_alert0').innerHTML = "";
	if (q4==""||q4=="Please select") {
		document.getElementById('ti_sur_alert0').innerHTML = "Please answer question 4.";
		return false;
	} else document.getElementById('ti_sur_alert0').innerHTML = "";
	if (q5=="") {
		document.getElementById('ti_sur_alert0').innerHTML = "Please answer question 5.";
		return false;
	} else document.getElementById('ti_sur_alert0').innerHTML = "";
}
else {
...
var firstname = document.getElementById('ti_sur_firstname').value
var lastname = document.getElementById('ti_sur_lastname').value
var address = document.getElementById('ti_sur_address').value
var city = document.getElementById('ti_sur_city').value
var zip = document.getElementById('ti_sur_zip').value
var state = document.getElementById('ti_sur_state').value
var email = document.getElementById('ti_sur_email').value
...
var post_url = "http://www.casinkadmin.com/liang/ti/promotion-july-survey-2014/storeForm.php";
...
if (jQuery.browser.msie && window.XDomainRequest) {
            ...
            xdr.onload = function() {
				...
				document.getElementById('ti_sur_firstname').value = ""
				document.getElementById('ti_sur_lastname').value = ""
				document.getElementById('ti_sur_address').value = ""
				document.getElementById('ti_sur_city').value = ""
				document.getElementById('ti_sur_zip').value = ""
				document.getElementById('ti_sur_state').value = ""
				document.getElementById('ti_sur_email').value= ""
            };
} 
else {
	jQuery.get(post_url,
...
jQuery(document).ready(function(){
	document.getElementById('ti_sur_alert0').innerHTML = "";
});

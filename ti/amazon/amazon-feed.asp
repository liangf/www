...
For Each ProductItem In OrderObj.Products 
	...
	Else 
		...
		image_link = "http://www.tomatoink.com/v/vspfiles/templates/10/images/nophoto.gif"
	End If
	...
	Next
	'Response.write("<br>")
	bullet_point(1) = "11% OFF coupon code AMAZ11"
	bullet_point(2) = "Free shipping on $50+ orders"
	bullet_point(4) = bullet_point(4) & " " & bullet_point(5)
	'bullet_point(5) = "1 year warranty"
	
	keywords(1) = brand
	keywords(2) = mpn
	
	
	f.Writeline (amazon_category & Tab & ProductItem.description & Tab & link & Tab & ProductItem.id & Tab & ProductItem.price & Tab & image_link & Tab & upc & Tab & brand & Tab & recommended_browse_node & Tab & ProductItem.description & Tab & "TomatoInk" & Tab & mpn & Tab & shipping_cost & Tab & model_number & Tab & weight & Tab & bullet_point(1) & Tab & bullet_point(2) & Tab & bullet_point(3) & Tab & bullet_point(4) & Tab & "1 year warranty" & Tab & keywords(1) & Tab & keywords(2) & Tab & keywords(3) & Tab & keywords(4))

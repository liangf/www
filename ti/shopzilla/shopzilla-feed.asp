...
Set f = thefso.CreateTextFile(Server.MapPath(CONFIGURATION_NEW_DATAFEED_PATH), True, False) 
	...
	f.Writeline (ProductItem.id & Tab & ProductItem.title & Tab & ProductItem.description & Tab & shopzilla_category & Tab & link & Tab & image_link & Tab & condition & Tab & availability & Tab & ProductItem.productprice & Tab & brand & Tab & mpn & Tab & ProductItem.listprice & Tab & ProductItem.Shipping & Tab & weight & Tab & "Save an extra 10% on any order")

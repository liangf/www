...
Class OrderTrackingCollector
	...
	Public Function RetrievePt() 'As ParentCategory
		...
		For Each PrNode In ProductNode
			...
			tmpProduct.productprice = Field(PrNode, "productprice")
			tmpProduct.listprice = Field(PrNode, "listprice")
			...
			Response.write(Field(PrNode, "productprice") & "<br>")
			Response.write(Field(PrNode, "listprice") & "<br>")

...
/*	
    ...
    jQuery.post("http://www.compandsave.com/v/dc/yy/liangf/promotion-july-survey-2014/time.asp", function(data) {
        if (data==1) {
 			document.getElementById( 'success_message' ).style.display = 'block';
			document.getElementById( 'cas_sur_surveySection' ).style.display = 'none';	
        }
    }); 	
*/
</script>

...
product_text = "This is the Default Text for product"
...
<div class="cas_cms_articleContent_area cas_sur_container">
		...
		<div class="cas_cms_seven firstCol">
			<div class="cas_sur_survey">
				<form>
					<ol>
						...
						<li><strong>Are you happy with frequency in which you receive emails from CompAndSave.com?</strong><br>
							...
							<div id='frequency_block'>
								...
								<p><input name="frequency" value="1" type="radio" checked/>Once a month
      							<input name="frequency" value="2" type="radio"/>Twice a month</p>
					...
					<p class="cas_sur_alert">This is where alerts will appear.</p>
				</form>
			</div>
		</div>
	...
	<div class="cas_cms_row cas_sur_freebieRow">
		<div class="cas_cms_seven firstCol">
			<div id="cas_sur_form_block">
				<p>Enter your information below to receive your free tote bag from CompAndSave.com!<br><em class="cas_cms_small-font">(U.S. only)</em></p>
				<div class="cas_cms_row">
				...
				<div class="cas_cms_row">
					<div class="cas_cms_twelve">
						<input id="cas_sur_email" type="text" value=" <% Response.write(Email_text) %>" onfocus="if(this.value==' Email')this.value='';" onblur="if(this.value=='')this.value=' Email';"/>
					</div>
				</div>
	...
	<div id='success_message'>Thank you for your time. Your 25% off exclusive coupon code and Reusable Shopping bag will be sent next week. In the meantime, please enjoy 12% off coupon code:
JULY12 <br>
		Hope Megan will help us add search bar here, Wooieeee <br>
		------------------------------------------------<br>
		[&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SEARCH&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>
		------------------------------------------------<br>
	</div>
...
$('input[name="product-type"]').change(function() {
	if ($('input[name="product-type"]:checked').val() == "no") {
		...
		$('#product_name').html("This is the Default Text for product");

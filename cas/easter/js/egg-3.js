	...
	FB.login(function (response){
		if (response.authResponse){
			...
			FB.ui(
			{
				...
				picture: 'http://www.compandsave.com/v/newsletter/promotion-april-2014/images/egg3-facebook.jpg',
				...
				if (response && response.post_id) {
					//tracking the event using ga.js
					_gaq.push(['_trackEvent', 'Easter', 'Epson', 'FBshare']);
					FB.api('/me', function(response) {
						//jQuery.post("http://www.casinkadmin.com/yy/liangf/compandsave/storeShare.php",
						jQuery.post("http://www.casinkadmin.com/liang/cas/easter/php/storeShare.php",
						//jQuery.post("http://www.866ink.com/liang/storeShare.php",
							{uname: response.name, uemail: response.email, uID: uid, ulink: response.link, ueggID: 3}, 
							function(data){ 
								...
								window.location.assign("http://www.compandsave.com/v/newsletter/promotion-april-2014/egg-3-thanks.html");
								//window.location.assign("http://www.compandsavetest.com/v/dc/liang/cas/easter/html/4-12/egg-3-thanks.html");
							}
						);
					});
				} 
...
function validateForm() {
	...
	_gaq.push(['_trackEvent', 'Easter', 'Epson', 'Newsletter']);
}
...
$(document).ready(function(){
	...
	if (user=="lp2") $('#easter_link_lp').attr('href', "http://www.compandsave.com/v/newsletter/promotion-april-2014/promotion-april-2014-2.asp?test=easter-egg");

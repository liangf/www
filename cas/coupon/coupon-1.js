...
if(typeof global_Current_ProductCode != "undefined") {
    ...
    jQuery.post("//www.compandsave.com/v/dc/yy/liangf/servertime/time5.asp", function(data) {
        ...
        if (data==1 && amazon_id == null) {
            ...
            couponDiv.id = "cas_cms_couponDivAmazon";
            document.getElementById("content_area").appendChild(couponDiv);
            document.getElementById("cas_cms_couponDivAmazon").innerHTML = '<p>Get 5% OFF<br>any order $5 or more!</p>'+'<p>Coupon expires today:</p>'+'<p><strong id="cas_cms_codeAmazon"></strong></p>';	
            document.getElementById('cas_cms_codeAmazon').innerHTML="5OFF";        
        }
    });   
}

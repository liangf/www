select Customers.EmailAddress, Customers.CustomerID, T.OrderID, T.LatestTime, T.ProductCode, T.maxQuantity, T.maxProductPrice from Customers
left join (
...
) T on Customers.CustomerID=T.CustomerID

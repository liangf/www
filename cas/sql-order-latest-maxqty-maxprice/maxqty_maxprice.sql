select ttt2.EmailAddress, ttt2.ProductCode, ttt2.maxQuantity, ttt1.maxProductPrice from (
...
) ttt2 on ttt2.EmailAddress=ttt1.EmailAddress and ttt2.maxQuantity=ttt1.maxQuantity and ttt2.ProductPrice=ttt1.maxProductPrice

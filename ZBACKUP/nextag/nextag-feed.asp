...
Set f = thefso.CreateTextFile(Server.MapPath(CONFIGURATION_NEW_DATAFEED_PATH), True, False) 
	...
	f.Writeline (ProductItem.title & Tab & ProductItem.description & Tab & ProductItem.productprice & Tab & ProductItem.link & Tab & nexttag_category & Tab & image_link & Tab & availability & Tab & condition & Tab & ProductItem.Shipping & Tab & weight & Tab & promo_type & Tab & promo_text & Tab & ProductItem.listprice & Tab & coupon_code_discount & Tab & coupon_url_discount)

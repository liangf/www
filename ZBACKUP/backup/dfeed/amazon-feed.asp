...
%>
<!-- #include file="includes/configuration.inc-google.asp" -->
...
Set f = thefso.CreateTextFile(Server.MapPath(CONFIGURATION_NEW_DATAFEED_PATH), True, False) 
	...
	'upc = "UPC"
	upc = ProductItem.upc
	'weight = ProductItem.weight & " pound"
	...
	f.Writeline (ProductItem.google_product_category & Tab & ProductItem.title & Tab & ProductItem.link & Tab & ProductItem.id & Tab & ProductItem.price & Tab & ProductItem.image_link & Tab & upc & Tab & brand & Tab & recommended_browse_node & Tab & ProductItem.description & Tab & manufacturer & Tab & mpn & Tab & shipping_cost & Tab & ProductItem.model_number & Tab & weight)
  Next   

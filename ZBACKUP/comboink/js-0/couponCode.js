...
function showRank() {
	...
	jQuery.post("http://www.casinkadmin.com/yy/liangf/tomatoink/getRank.php",
		{utime: ttime}, 
		function(data){ 
			//alert(data);
			var arr = data.split("?");
...
function storeRank() {
		...
		jQuery.post("http://www.casinkadmin.com/yy/liangf/tomatoink/storeRank.php",

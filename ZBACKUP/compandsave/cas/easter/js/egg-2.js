	...
	FB.login(function (response){
		if (response.authResponse){
			...
			FB.ui(
			{
				...
				picture: 'http://www.compandsave.com/v/newsletter/promotion-april-2014/images/egg2-facebook.jpg',
				...
				if (response && response.post_id) {
					_gaq.push(['_trackEvent', 'Easter', 'HP', 'FBshare']);
					FB.api('/me', function(response) {
						...
						//jQuery.post("http://www.866ink.com/liang/storeShare.php",
							{uname: response.name, uemail: response.email, uID: uid, ulink: response.link, ueggID: 2}, 
							function(data){ 
								...
								window.location.assign("http://www.compandsave.com/v/newsletter/promotion-april-2014/egg-2-thanks.html");
								//window.location.assign("http://www.compandsavetest.com/v/dc/liang/cas/easter/html/4-12/egg-2-thanks.html");
							}
						);
					});
				} 
...
function validateForm() {
	...
	_gaq.push(['_trackEvent', 'Easter', 'HP', 'Newsletter']);
}

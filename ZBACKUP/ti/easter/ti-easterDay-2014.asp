...
-->
<link rel="stylesheet" href="//www.tomatoink.com/v/newsletter/promotion-Apr2014/css/ti-easterDay-2014.css"></link>
...
<script src="//www.tomatoink.com/v/newsletter/promotion-Apr2014/js/jquery.js" type="text/javascript"></script>
-->

<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>

<!--
<script type="text/javascript" src="//www.tomatoink.com/v/newsletter/promotion-Apr2014/js/couponCode.js"></script>
<script type="text/javascript" src="http://www.tomatoink.com/v/dc/yy/liangf/tomatoink/js/voteAnimal.js"></script>

-->
<script type="text/javascript" src="//www.casinkadmin.com/liang/ti/js/voteAnimal.js"></script>
...
<script>
$(document).ready(function() {
	//document.getElementsByTagName('head')[0].innerHTML += '<meta id="viewport" name="viewport" http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">';

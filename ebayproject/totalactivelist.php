...
function diffMerge() {
	...
	//$sql = "SELECT a.customlabel, t.price, a.costprice, a.shippingcost FROM ebay_tmpa as a left JOIN ebay_tmpt as t ON a.customlabel2=t.customlabel2";
	//$sql = "SELECT t.customlabel, t.price, a.costprice, a.shippingcost FROM ebay_tmpa as a right JOIN ebay_tmpt as t ON a.customlabel2=t.customlabel2";
	//$sql="SELECT a.customlabel, t.price, a.costprice, a.shippingcost FROM ebay_tmpa as a left JOIN ebay_tmpt as t ON a.customlabel2=t.customlabel2 where a.customlabel='JL-BR-TN650-4-MFX-(4 BK)'";
	$result = mysql_query($sql);
	$row = mysql_num_rows($result);
	if ($row>=1) {
		echo '<table border="1px">';

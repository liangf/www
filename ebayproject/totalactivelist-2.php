...
function showMerge() {	
	...
	if ($row>=1) {
		while($array = mysql_fetch_array($result)) {
			...
			//if( !mysql_query($sql) ) echo "'" .$customlabel ."'" ." added no success. <br>";
			//if( !mysql_query($sql_p) ) echo $customlabel .", " .$price.", ".$costprice.", ".$shippingcost.", ".$fvf.", ".$jl5.", ".$paypalfee.", ".$netprofit.", ".$morethan5 ." added no success. <br>";
		}
	} else { echo "No data in DB.<br>";}	
	
/*	
	// take data from eby_profit Table

	...
	<TR>
	  <TD>Return Within</TD>
		<TD>
		  ...
		  Set this field only if you have selected "ReturnsAccepted"
        </TD>
	</TR>
	<TR>
...
<?php
    if(isset($_POST['listingType']))
	{
		...
		if(isset($_POST['returnsAccepted'])){
		    $returnsAccepted = $_POST['returnsAccepted'];
			   $requestXmlBody .= "<ReturnsAcceptedOption>$returnsAccepted</ReturnsAcceptedOption>";
		    if($returnsAccepted == 'ReturnsAccepted'){
			    $requestXmlBody .= "<RefundOption>MoneyBack</RefundOption>";
				if(isset($_POST['returnWithin'])) {

...
$file = fopen("Brand_Specific_CAS.csv", "w");


$count = 0;
$array_email = array();
$sql = "SELECT * FROM july_survey2 where FormID=1";
...
echo "july_survey2" ." => " ."cas: " .$count . "<br>";




$array_email2 = array();
$sql2 = "SELECT * FROM customer_behavior_cas";
...
echo "customer_behavior_cas" ." AFTER SUBTRACTION: " .count($array_email2)  ."<br>";
...
echo "cas write: " .$count . "/" . ($count+$count2) ."<br>";
echo "<br><br>";

...
if(!$("#policy_check").is(':checked')) {
	...
	FB.login(function (response){
		if (response.authResponse){
			...
			{
				method: 'feed',
				name: 'CompAndSave July Giveaway',
				link: 'http://www.compandsave.com/v/newsletter/promotion-independence2014/cas-independence-2014.asp',
				picture: 'http://compandsave.com/v/newsletter/promotion-independence2014/images/cas-independence-bg.jpg',
				description: 'Join the hunt at CompAndSave.com and win the Giveaway',
				message: 'CompAndSave July Giveaway!'
			},function(response) {
				if (response && response.post_id) {
					...
					//window.location = "https://secure.compandsave.com/lf/fbtemplate/sweepstakes.php?firstname=liang&lastname=fang&email=liangf%40compandsave.com&address=112+regency&city=newark&zip=12345&state=ca";
					var url = "https://secure.compandsave.com/lf/fbtemplate/sweepstakes.php?";
					url = url+"firstname="+firstname+"&lastname="+lastname+"&email="+email+"&address="+address+"&city="+city+"&zip="+zip+"&state="+state;
					window.location = url;

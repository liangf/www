...
$sql = "delete FROM ti_fbstore";
mysql_query($sql);

?>

<?php
$myfile = fopen("TomatoInk_Feed_fbstore.txt", "r") or die("Unable to open file!");
...
while(!feof($myfile)) {
	...
	$sql = "insert into ti_fbstore (productid, shorttitle, longtitle, producturl, imageurl, longtitle2, price) values('$productid', '$shorttitle', '$longtitle', '$producturl', '$imageurl', '$longtitle2', $price)";

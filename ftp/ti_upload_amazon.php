...
$ftp_get_server = "www.tomatoink.com";
...
$server_file = "./liangf/feeds/amazon/Tomatoink_Feed_Amazon.txt";
$local_file = "./feeds/Tomatoink_Feed_Amazon.txt";
...
$sftp_put_username = "M_TOMATOINK_15997329";
$sftp_put_userpass = "GJ2uWSqUV4";
//$server_file = "./www/ftp/Amazon_datafeed.txt";
$server_file = "./Tomatoink_Feed_Amazon.txt";
$local_file = "./feeds/Tomatoink_Feed_Amazon.txt";

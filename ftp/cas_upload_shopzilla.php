...
$server_file = "./liangf/feeds/shopzilla/CompandSave_Feed_Shopzilla.txt";
$local_file = "./feeds/CompandSave_Feed_Shopzilla.txt";
...
$ftp_put_username = "129086_wlY9Ol";
$ftp_put_userpass = "Gk8KEq";

...
$server_file = "./liangf/feeds/shopzilla/Comboink_Feed_Shopzilla.txt";
$local_file = "./feeds/Comboink_Feed_Shopzilla.txt";
...
$ftp_put_username = "233322_X1wNPr";
$ftp_put_userpass = "JuMLvx";
//$server_file = "/v/dc/yy/liangf/amazonfeed/Amazon_datafeed.txt";
$server_file = "./Comboink_Feed_Shopzilla.txt";
$local_file = "./feeds/Comboink_Feed_Shopzilla.txt";

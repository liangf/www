...
$server_file = "./liangf/feeds/shopzilla/TomatoInk_Product_Feed.txt";
$local_file = "./feeds/TomatoInk_Product_Feed.txt";
...
$ftp_put_username = "260379_s9YWG4z";
$ftp_put_userpass = "xt5y3bx";
//$server_file = "/v/dc/yy/liangf/amazonfeed/Amazon_datafeed.txt";
$server_file = "./TomatoInk_Product_Feed.txt";
$local_file = "./feeds/TomatoInk_Product_Feed.txt";

...
$server_file = "./liangf/feeds/nextag/CompandSave_Feed_Nextag.txt";
$local_file = "./feeds/CompandSave_Feed_Nextag.txt";
...
// connect and login to FTP server
$ftp_put_server = "upload.nextag.com";
$ftp_put_username = "lubu12";
$ftp_put_userpass = "qggd59*";
//$server_file = "/v/dc/yy/liangf/amazonfeed/Amazon_datafeed.txt";
$server_file = "./CompandSave_Feed_Nextag.txt";
$local_file = "./feeds/CompandSave_Feed_Nextag.txt";

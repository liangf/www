...
Class Product
	...
	public upc
	public weight
	public productdescriptionshort	
	...
	Public Function reflect()
		...
		With reflect			
			...
			.Add "upc", upc
			.Add "weight", weight
			.Add "productdescriptionshort", productdescriptionshort
...
Class OrderTrackingCollector
	...
	Public Function RetrievePt() 'As ParentCategory
		...
		For Each PrNode In ProductNode
			...
			tmpProduct.productdescriptionshort = Field(PrNode, "productdescriptionshort")
			tmpProduct.productdescription = Field(PrNode, "productdescription")

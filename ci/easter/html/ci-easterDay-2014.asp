...
<!--
<script src="http://www.comboink.com/v/newsletter/promotion-Apr2014/js/randomMotion.js" type="text/javascript"></script>
<script src="http://www.comboink.com/v/newsletter/promotion-Apr2014/js/stop-watch.js" type="text/javascript"></script>
<script src="http://www.comboink.com/v/newsletter/promotion-Apr2014/js/couponCode.js" type="text/javascript"></script>
-->
<!--end JS-->
...
<div class="ci-ed-contentArea">
	...
	<form name="clockform">
		<div id="ci-ed-stopWatch" class="ci-ed-stopWatch">
			<span>		
				<input name="clock" value="00:00.00" class="ci-ed-clock" />
	...
	<div id="ci-ed-option" class="ci-ed-option" style="display:block;">
		<div id="ci-ed-hardBn" class="ci-ed-hardBn">Difficult</div>
...
<!--Search Bar-->	
	<div id="ci-ed-reward" class="ci-ed-reward" style="display:block;">
		<div id="ci-ed-startBoard" class="ci-ed-StartBoard" style="display:block">
			<h1 class="ci-ed-highlight">How to get 15% off ink coupon</h1>
			<ul>
				<li>Click <strong>start button</strong> below </li>
				<li>Click on egg to catch & reveal <strong>15% off</strong> ink coupon</li>
			</ul>
			<input name="starter" onclick="findTIME()" type="button" value="Start" id="ci-ed-start" class="ci-ed-start" style="display:block" />			
		</div>
		<div id="ci-ed-couponCode" class="ci-ed-couponCode" style="display:none;">
		...
		<div id="ci-ed-top10" class="ci-ed-top10" style="display:none;">
		<form action="" method="post" enctype="multipart/form-data">
			<table cellspacing="0" border="0">
						...
						<table width="701" id="ci-ed-rankName" class="ci-ed-rankName" style="display:block">
							<tr height="15">
								<td width="260" valign="bottom">
									<div id="ci-ed-rank" class="ci-ed-rank">Your rank is: <span id="ci-ed-vrank">9999</span></div>
								</td>
								<td valign="bottom">
									<span>Your name: </span>
				...
				<tr>
					<td colspan="2" align="center" class="ci-ed-highlight">		Hall of Fame
					</td>
					<td></td>
				</tr>
				<tr>
		...
		<div id="ci-ed-eggClick" class="ci-ed-eggClick" style="display:none;">
		<form name="findTime1()">
			<input name="stopper" onmousedown="" value="" type="button" id="ci-ed-stop" class="ci-ed-stop">
		</form>	
		</div>

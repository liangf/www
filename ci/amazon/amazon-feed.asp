...
For Each ProductItem In OrderObj.Products 
	...
	Else 
		...
		image_link = "http://www.comboink.com/v/vspfiles/templates/10/images/nophoto.gif"
	End If
	...
	'bullet_point(4) = "New Compatible/Remanufactured/New (use one of them) ink cartridge/toner cartridge/drum unit/photo paper/printer accessories"

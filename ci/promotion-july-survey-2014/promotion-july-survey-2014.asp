...
Dim image_url
Dim product_text
image_url = "images/ink-group.jpg" 
...
<link href="/v/newsletter/promotion-july-survey-2014/css/2014-july-survey-ci.css" rel='stylesheet' type='text/css'>
<script language="javascript" src="//www.comboink.com/v/dc/yy/liangf/promotion-july-survey-2014/subSurvey.js"></script>

<% if flag_run = 1 then %>
<div class="ci_cms_articleContent_area ci_sur_container">
	<div id='expire_message' class="ci_cms_row">
		<div class="ci_cms_twelve">
			<h2>
Thank you for your interest, but unfortunately this survey has ended since we've reached our maximum amount of entries. If you answered the questions correctly, look forward to your exclusive discount coupon via email on the 16th of July. Otherwise, please enjoy the 12% off coupon code below, before it expires on the 28th of July:<br><span class="ci_sur_coupon">JULY12</span></h2>
		</div>
		<div class="ci_cms_twelve ci_sur_searchBar">
			<div id="ci_sur_searchbarContainer">
				<form id="nxt-ac-form" onsubmit="return submitSearch5();" action="http://search.comboink.com/search" method="get" name="form5">
					...
					<input type="submit" border="0" onclick="submitSearch5();" value="Search" name="imageField" class="ci_cms_redBtn">
				</form>
			</div>
		</div>
	</div>
...
<div id='ci_survey_popout' class='ci_cms_articleContent_area'><h2 class='ci_cms_centerTxt'>You are not currently subscribed to ComboInk.com's Newsletter List!<br>This promotion is exclusive to our customers &amp; current subscribers!</h2><h2 class='ci_cms_centerTxt'>Please sign up to our newsletter list<br>so you don't miss any future offers:</h2><p class='ci_cms_centerTxt'><a class='btn ci_cms_redBtn' href='http://www.comboink.com/MailingList_subscribe.asp' target='_blank'>Sign up for offers</a> <a class='btn ci_cms_redBtn' href='http://www.comboink.com'>Return home</a></p></div>
<div id='ci_survey_gray'></div>
...
<div class="ci_cms_articleContent_area ci_sur_container">
	...
	<div id="ci_sur_surveySection">
		<div class="ci_cms_row ci_sur_backdrop">
			<div class="ci_cms_twelve">
				<h1>Receive your FREE apron and 25% off coupon code if you take our short survey:</h1>
			</div>
		</div>
		<div class="ci_cms_row">
			<div class="ci_cms_seven firstCol">
				<div class="ci_sur_survey">
					<form>
						<ol>
							<% IF ProductCode <> "" THEN %>
							...
							<li><strong>Are you happy with frequency in which you receive emails from ComboInk.com?</strong><br>
						...
						<p id="ci_sur_alert0" class="ci_sur_alert"></p>
					</form>
				</div>
			</div>
			<div class="ci_cms_five lastCol">
				<img id="product_image" src="<% Response.write(image_url) %>" alt="Shop ink and toner and save up to 80% every day!" class="ci_cms_width100"/>
				<h3 id="product_name" class="ci_sur_productName"><% Response.write(product_text) %></h3>
			</div>
		</div>
		<div class="ci_cms_row ci_sur_freebieRow">
			<div class="ci_cms_seven firstCol">
				<div id="ci_sur_form_block">
					<p>Enter your information below to receive your free apron (or gift of equal value) from ComboInk.com!<br><em class="ci_cms_small-font">(U.S. and Canada only)</em></p>
					<div class="ci_cms_row">
						<div class="ci_cms_six firstCol">
							<input id="ci_sur_firstname" type="text" value=" <% Response.write(FirstName_text) %>" onfocus="if(this.value==' First Name')this.value='';" onblur="if(this.value=='')this.value=' First Name';"/>
						</div>
						<div class="ci_cms_six lastCol">
							<input id="ci_sur_lastname" type="text" value=" <% Response.write(LastName_text) %>" onfocus="if(this.value==' Last Name')this.value='';" onblur="if(this.value=='')this.value=' Last Name';"/>
						</div>
					</div>
					<div class="ci_cms_row">
						<div class="ci_cms_twelve">
							<input id="ci_sur_address" type="text" value=" <% Response.write(Address_text) %>" onfocus="if(this.value==' Address')this.value='';" onblur="if(this.value=='')this.value=' Address';"/>
						</div>
					</div>
					<div class="ci_cms_row">
						<div class="ci_cms_eight firstCol">
							<input id="ci_sur_city" type="text" value=" <% Response.write(City_text) %>"  onfocus="if(this.value==' City')this.value='';" onblur="if(this.value=='')this.value=' City';"/>
						</div>
						<div class="ci_cms_four lastCol">
							<input id="ci_sur_state" type="text" value=" <% Response.write(State_text) %>" onfocus="if(this.value==' State')this.value='';" onblur="if(this.value=='')this.value=' State';"/>
						</div>
					</div>
					<div class="ci_cms_row">
						<div class="ci_cms_eight firstCol">
							<input id="ci_sur_zip" type="text" value=" <% Response.write(ZipCode_text) %>" onfocus="if(this.value==' Zip Code')this.value='';" onblur="if(this.value=='')this.value=' Zip Code';"/>
						</div>
						<div class="ci_cms_four lastCol">
							<input id="ci_sur_country" type="text" value=" <% Response.write(Country_text) %>" onfocus="if(this.value==' Country')this.value='';" onblur="if(this.value=='')this.value=' Country';"/>
						</div>
					</div>
					<div class="ci_cms_row">
						<div class="ci_cms_twelve">
							<input id="ci_sur_email" type="text" readonly="readonly" value=" <% Response.write(Email_text) %>" onfocus="if(this.value==' Email')this.value='';" onblur="if(this.value=='')this.value=' Email';"/>
						</div>
					</div>
					...
					<div class="ci_cms_row">
						<input id="ci_sur_submitEntry" type="submit" value="Submit" class="ci_cms_twelve ci_cms_redBtn" onClick="subForm(2)"/>
					</div>
					<p id="ci_sur_alert"></p>
				</div>
			</div>
			<div class="ci_cms_five lastCol" id="ci_sur_freebie_block">
				<img class="ci_cms_width100" src="images/free.jpg" alt="Free apron from ComboInk.com">
			</div>
		</div>
	</div>
	<!--end survey section-->
	<div id='success_message' class="ci_cms_row">
		<div class="ci_cms_twelve">
			<h2>Thank you for your time. Your 25% off exclusive coupon code and apron will be sent next week.</h2>
			<h2>In the meantime, please enjoy this 12% off coupon code:<br><span class="ci_sur_coupon">JULY12</span></h2>
		</div>
		<div class="ci_cms_twelve ci_sur_searchBar">
			<div id="ci_sur_searchbarContainer">
				<form id="nxt-ac-form" onsubmit="return submitSearch5();" action="http://search.comboink.com/search" method="get" name="form5">
	...
	<div class="ci_cms_row">
		<div class="ci_cms_one first"></div>
		<div class="ci_cms_ten">
			<p><strong>Disclaimer:</strong> Only current ComboInk.com customers and subscribers are eligible to receive this offer. Limit one apron per household. Multiple entries will not result in multiple aprons being sent to the same household or multiple coupon codes being sent to the same email address. Aprons will be sent within 7-10 business days at no cost to the user. An item of equal value will be sent if aprons are out of stock. Your 25% off coupon code will be emailed within 10 business days. For additional questions or comments, please contact <a href="mailto:customercare@comboink.com">customercare@comboink.com</a>. Click <a target="_blank" href="../../../terms_privacy.asp">here</a> for more information about our privacy policy. ComboInk.com reserves the right to cancel this promotion without prior notice. Offer ends 7/14/2014 11:59 PST or while supplies last.</p>
		</div>
		<div class="ci_cms_one last"></div>
	</div>
</div>
<% end if %>
<style type="text/css">
...
jQuery('input[name="product-type"]').change(function() {
	if (jQuery('input[name="product-type"]:checked').val() == "no") {
		jQuery('#product_image').attr('src', "images/ink-group.jpg");
...
<script type='text/javascript'>
	jQuery('#submitBtn').click(function() {
		...
		if (jQuery.browser.msie && window.XDomainRequest) {
			...
			post_url = "http://www.casinkadmin.com/yy/MailChimp/unsubscriber_ci.php?method=" + method + "&email=" + email + "&reason=";
			xdr.open("GET", post_url);
			xdr.send();
			xdr.onload = function() {
				var data = xdr.responseText;
				console.log("IE databack: " + data);
				if (data == "noexist") {jQuery('#unsuccess_text_frequency').html("<p class='ci_sur_alert'>You are not in our email list.</p>");}
				else if (data == "update") {
			...
			jQuery.get("http://www.casinkadmin.com/yy/MailChimp/unsubscriber_ci.php", {method:method, email:email, reason: ""}, function(data) {
				if (data == "noexist") {jQuery('#unsuccess_text_frequency').html("<p class='ci_sur_alert'>You are not in our email list.</p>");}
				else if (data == "update") {
					jQuery('#frequency_block').html("<p>You have successfully updated your email frequency</p>");

...
if (product_code_radio != null) {
	if (q1=="") {
		document.getElementById('ci_sur_alert0').innerHTML = "Please answer question 1.";
		return false;
	} else document.getElementById('ci_sur_alert0').innerHTML = "";
	if (q2==""||q2=="Printer Model") {
		document.getElementById('ci_sur_alert0').innerHTML = "Please answer question 2.";
		return false;
	} else document.getElementById('ci_sur_alert0').innerHTML = "";
	if (q3==""||q3=="MM/DD/YYYY") {
		document.getElementById('ci_sur_alert0').innerHTML = "Please answer question 3.";
		return false;
	} else document.getElementById('ci_sur_alert0').innerHTML = "";
	if (q4==""||q4=="Please select") {
		document.getElementById('ci_sur_alert0').innerHTML = "Please answer question 4.";
		return false;
	} else document.getElementById('ci_sur_alert0').innerHTML = "";
	if (q5=="") {
		document.getElementById('ci_sur_alert0').innerHTML = "Please answer question 5.";
		return false;
	} else document.getElementById('ci_sur_alert0').innerHTML = "";
}
else {
